		...
		<div class="card shadow mb-4">
            ...
            <div class="card-body">
				...
				<?= form_open_multipart($form, array("class" => "") );?>
					...
					<input type="hidden" name="id_jenis" value="<?= isset($id_jenis)?$id_jenis:'';?>">
					
					<div class="form-group row">
						<label for="type" class="col-sm-2 control-label">Type</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" id="type" name="type" value="<?= isset($type)?$type:"";?>" placeholder="Type" required>
						</div>
					</div>
					<div class="form-group row">
